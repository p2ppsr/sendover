...
module.exports = ({ senderPrivateKey, recipientPublicKey, invoiceNumber, returnType = 'address' }) => {
    ...
    if (typeof recipientPublicKey === 'string') {
        publicKey = babbage_bsv_1.default.PublicKey.fromString(recipientPublicKey);
    }
    else if (recipientPublicKey instanceof babbage_bsv_1.default.PublicKey) {
    ...
    else if (senderPrivateKey instanceof babbage_bsv_1.default.PrivateKey) {
